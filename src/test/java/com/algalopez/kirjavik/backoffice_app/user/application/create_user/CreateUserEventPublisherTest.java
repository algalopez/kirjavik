...
class CreateUserEventPublisherTest {
  ...
  void setUp() {
    ...
    createUserEventPublisher = new CreateUserEventPublisher(domainMetadataService, eventBusPort);
  }
