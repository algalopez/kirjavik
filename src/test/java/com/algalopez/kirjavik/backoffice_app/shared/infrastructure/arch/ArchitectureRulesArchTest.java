  ...
  void architecture_shouldFollowDependencyRule() {
    Architectures.LayeredArchitecture layeredArchitecture =
        Architectures.layeredArchitecture()
            ...
            .layer("Api")
            .definedBy("..kirjavik.backoffice_app.*.api..", "..kirjavik.shared.api..")
            .layer("Application")
            .definedBy("..kirjavik.backoffice_app.*.application..", "..kirjavik.shared.application..")
            .layer("Domain")
            .definedBy("..kirjavik.backoffice_app.*.domain..", "..kirjavik.shared.domain..")
            .layer("Infrastructure")
            .definedBy(
                "..kirjavik.backoffice_app.*.infrastructure..", "..kirjavik.shared.infrastructure..");
    ...
    ArchRule archRule =
        ArchRuleDefinition.noClasses()
            ...
            .resideOutsideOfPackages(
                ...
                "..kirjavik.backoffice_app.*.application..",
                "..kirjavik.backoffice_app.*.domain..",
                "..kirjavik.backoffice_app.*.infrastructure..");
