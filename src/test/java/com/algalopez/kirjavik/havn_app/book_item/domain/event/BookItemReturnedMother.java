...
public class BookItemReturnedMother {
  private String id;
  ...
  public BookItemReturnedMother() {
    ...
    this.eventType = BookItemReturned.EVENT_TYPE;
    this.aggregateId = this.id;
    this.aggregateType = BookItemReturned.AGGREGATE_TYPE;
    this.dateTime =
        faker
            .timeAndDate()
